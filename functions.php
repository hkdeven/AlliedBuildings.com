...
function blade_enqueue_styles() {  // This loads the js from the parent theme 'Blade' - AFTER all other js listed here
...
add_action( 'wp_enqueue_scripts', 'blade_enqueue_styles' );
